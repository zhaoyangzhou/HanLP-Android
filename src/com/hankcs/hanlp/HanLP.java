...
public class HanLP
{
    ...
    public final static class Config
    {
        ...
        public static void init(String configPath, String rootDictionaryPath)
        {
            ...
            try
            {
                ...
                p.load(new InputStreamReader(Predefine.HANLP_PROPERTIES_PATH == null ?
                    ...
                    , "UTF-8"));
                String root = rootDictionaryPath == null ? p.getProperty("root", "").replaceAll("\\\\", "/") : rootDictionaryPath;
    ...
    {
    	char[] originCharArray = text.toCharArray();
        ...
        for (Pinyin pinyin : pinyinList)
        {
        	if (pinyin.name().equals(Pinyin.none5.name())) {
        		if (originCharArray[i - 1] != ' ') {
        			char originChar = originCharArray[i - 1];
        			int originCharAscII = (int) originChar;
        			if (originCharAscII >= 65313 && originCharAscII < 65339) {//Ａ-Ｚ非正常字母转换为正常字母
        				sb.append((char) (originCharAscII - 65313 + 97));
        			} else {
